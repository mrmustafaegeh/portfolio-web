      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {offerings.map((service, idx) => (
            ...
            >
              <div className={`w-16 h-16 rounded-3xl mb-8 flex items-center justify-center bg-${service.color}-50 dark:bg-${service.color}-900/20 text-${service.color}-500 shadow-sm`}>
                {service.icon}
              </div>
